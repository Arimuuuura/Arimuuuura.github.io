...
('use strict');
{
  ...
  const zipcodeApi = async (zipData) => {
    ...
    const res = await window.fetch(
      `https://api.openweathermap.org/data/2.5/weather?zip=${zipData},jp&appid=8f241f6e111e93a94a517a3c6477329e&lang=ja&units=metric`
    );
  ...
  const weekzipApi = async (zipData) => {
    const res = await window.fetch(
      `https://api.openweathermap.org/data/2.5/forecast?zip=${zipData},jp&appid=8f241f6e111e93a94a517a3c6477329e&lang=ja&units=metric`
    );
    const api_ob = await res.json();
    return api_ob;
  };
  ...
  const cityApi = async (cityData) => {
    const res = await window.fetch(
      `https://api.openweathermap.org/data/2.5/weather?id=${cityData}&appid=8f241f6e111e93a94a517a3c6477329e&lang=ja&units=metric`
    );
    const api_ob = await res.json();
    return api_ob;
  };
  ...
  const weekcityApi = async (cityData) => {
    const res = await window.fetch(
      `https://api.openweathermap.org/data/2.5/forecast?id=${cityData}&appid=8f241f6e111e93a94a517a3c6477329e&lang=ja&units=metric`
    );
    const api_ob = await res.json();
    return api_ob;
  };
